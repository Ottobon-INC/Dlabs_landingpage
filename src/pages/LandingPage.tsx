             ...
             <div className="lg:w-5/12 flex flex-col justify-center space-y-4 border-r border-teal-50 pr-0 lg:pr-8">
               {[1, 2, 3, 4, 5].map((step) => (
                 <div 
                   ...
                   className={`px-6 py-5 rounded-2xl cursor-pointer transition-all duration-300 border-2 flex items-center ${
                 ...
                 >
                   <div className={`w-10 h-10 rounded-full flex items-center justify-center font-black mr-4 ${
                     activeWorkflowStep === step ? 'bg-teal-600 text-white shadow-sm' : 'bg-slate-100 text-slate-500'
                   }`}>
                     {step}
                   </div>
                   <h3 className={`text-xl lg:text-xl font-black ${
                     activeWorkflowStep === step ? 'text-teal-900' : 'text-slate-500'
                   }`}>
